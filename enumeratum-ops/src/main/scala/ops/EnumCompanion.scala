...
sealed trait AnyEnumCompanion[E] {
...
trait EnumCompanion[E <: EnumEntry] extends AnyEnumCompanion[E] with Enum[E] {
...
trait ValueEnumCompanion[E <: ValueEnumEntry[_]] extends AnyEnumCompanion[E] {
